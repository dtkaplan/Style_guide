# Style_guide for StatPREP Lessons
...
3. Set the default knitr table printing method to XXXX so that the printing command does not need to be part of a command displayed to students. 
